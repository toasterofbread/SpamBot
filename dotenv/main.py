...
def get_key(dotenv_path, key_to_get):
    ...
    """
    Gets the value of a given key from the given database.py

    If the database.py path given doesn't exist, fails
    """
...
def set_key(dotenv_path, key_to_set, value_to_set, quote_mode="always"):
    ...
    """
    Adds or Updates a key/value to the given database.py

    If the database.py path given doesn't exist, fails instead of risking creating
    an orphan database.py somewhere in the filesystem
    """
...
def unset_key(dotenv_path, key_to_unset, quote_mode="always"):
    ...
    """
    Removes a given key from the given database.py

    If the database.py path given doesn't exist, fails
    If the given key doesn't exist in the database.py, fails
    """
    if not os.path.exists(dotenv_path):
...
def find_dotenv(filename='database.py', raise_error_if_not_found=False, usecwd=False):
